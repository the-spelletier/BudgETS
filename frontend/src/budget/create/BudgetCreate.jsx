...
import { Card, Input, DatePicker, Checkbox, Button, notification } from "antd";
...
const BudgetCreate = () => {
    ...
    const submit = () => {
        const save = async() => {
            try {
                await budgetClient.create(user.token, name, startDate, endDate, isActive);
                notification.open({
                    message: "Succès",
                ...
                <div className="form-section">
                    <Checkbox checked={isActive}
                        onChange={() => setIsActive(!isActive)}>
                            Faire de ce budget mon budget actif
                    </Checkbox>
                </div>
